(function (name, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(require('../..'), require('../lib/immutato'));
    } else {
        this[name] = factory(this.immutato_prev, this.immutato);
    }
}('all-benchmarks', function (__external_immutato_prev, __external_immutato, define) {
        ...
        function (module, exports) {
            function universalModule() {
                ...
                $traceurRuntime.createClass(Iterable, {
                    ...
                    concat: function () {
                        for (var values = [], $__2 = 0; $__2 < arguments.length; $__2++)
                ...
                var $SetSeq = SetSeq;
                $traceurRuntime.createClass(SetSeq, {
                    toSetSeq: function () {
                        return this;
                    }
                }, {
                ...
                $traceurRuntime.createClass(Map, {
                    ...
                    mergeWith: function (merger) {
                        for (var iters = [], $__3 = 1; $__3 < arguments.length; $__3++)
                    ...
                    mergeDeepWith: function (merger) {
                        for (var iters = [], $__4 = 1; $__4 < arguments.length; $__4++)
                ...
                $traceurRuntime.createClass(MapIterator, {
                    next: function () {
                        var type = this._type;
                ...
                $traceurRuntime.createClass(List, {
                    ...
                    mergeWith: function (merger) {
                        for (var iters = [], $__5 = 1; $__5 < arguments.length; $__5++)
                    ...
                    mergeDeepWith: function (merger) {
                        for (var iters = [], $__6 = 1; $__6 < arguments.length; $__6++)
                ...
                $traceurRuntime.createClass(ListIterator, {
                    next: function () {
                        var stack = this._stack;
                        while (stack) {
                ...
                $traceurRuntime.createClass(Stack, {
                    ...
                    slice: function (begin, end) {
                        ...
                        if (resolvedEnd !== this.size) {
                            return $traceurRuntime.superCall(this, $Stack.prototype, 'slice', [
                                begin,
                                end
                            ]);
                        }
                ...
                $traceurRuntime.createClass(Set, {
                    ...
                    intersect: function () {
                        for (var iters = [], $__7 = 0; $__7 < arguments.length; $__7++)
                    ...
                    subtract: function () {
                        for (var iters = [], $__8 = 0; $__8 < arguments.length; $__8++)
                    ...
                    mergeWith: function (merger) {
                        for (var iters = [], $__9 = 1; $__9 < arguments.length; $__9++)
                ...
                $traceurRuntime.createClass(OrderedSet, {
                    toString: function () {
